...
@InputType()
class DatumUpdateManyWithoutCountriesInput {
  ...
  disconnect?: Array<DatumWhereUniqueInput>;
  ...
  set?: Array<DatumWhereUniqueInput>;
}
export { DatumUpdateManyWithoutCountriesInput };
